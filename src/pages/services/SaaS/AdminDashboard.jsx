...
const AdminDashboard = () => {
    ...
    switch (activeSection) {
      ...
      case "settings":
        return (
          <div>
            <div style={{ marginBottom: "2rem" }}>
              <h2 style={{ fontSize: "2rem", fontWeight: "600", color: "#1f2937", marginBottom: "0.5rem" }}>Settings</h2>
              <p style={{ color: "#6b7280" }}>Configure your platform settings and preferences.</p>
            </div>
              ...
              {["general", "security", "notifications", "billing", "integrations", "appearance"].map((tab) => (
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    background: "transparent",
                    color: tab === "general" ? "#3b82f6" : "#6b7280",
                    borderBottom: tab === "general" ? "2px solid #3b82f6" : "2px solid transparent",
                    fontWeight: "500",
                    cursor: "pointer",
                    textTransform: "capitalize",
                    whiteSpace: "nowrap"
                  }}
                  onClick={() => alert(`Switch to ${tab} settings`)}
                >
                  {tab}
                </button>
              ))}
  ...
  const menuItems = [
    ...
    { 
      id: "my-activity", 
      label: "My Activity (as Customer)", 
      icon: "📱", 
      hasSubmenu: true,
      submenu: [
        { id: "my-software-subscriptions", label: "My Software Subscriptions", icon: "💿" },
        { id: "my-billing-history", label: "My Billing History", icon: "🧾" },
        { id: "my-customer-profile", label: "My Customer Profile", icon: "👤" }
      ]
    },
